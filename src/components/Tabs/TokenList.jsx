...
const TokenList = ({ walletAddress, selectedChain }) => {
    ...
    useEffect(() => {
        ...
        initialize();
    }, [selectedChain,selectedToken, sendModalVisible]);
            ...
            const updatedTokens = await Promise.all(fetchedTokens.map(async (token) => {
                try {
                    ...
                    return {
                        ...
                        logo: `/svg/color/${symbol.toLowerCase()}.svg` // Add your logo logic here
                    };
                } catch (error) {
    ...
    return (
        <>
            ...
            <TokenTransfer selectedToken={selectedToken}
                sendModalVisible={sendModalVisible} setSendModalVisible={setSendModalVisible} walletAddress={walletAddress} erc20ABI = {erc20ABI} provider = {provider} selectedChain = {selectedChain}/>
        </>
    );
};
